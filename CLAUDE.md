...
| [CLAUDE_WEB.md](CLAUDE_WEB.md) | `web/`-specific: Registration (Location wizard), Cabinet Management (Location→cabinet→settings; Assign User / Keys / Key Permission / Key Access), User Management, Dashboard Overview, Sign out + Website settings, session-expiry → login, login email+password only, Deleted items / Erase data, `web/` Project Status |
