...
export const MALAYSIA_STATES: MalaysiaState[] = [
  ...
  },
  {
    ...
    lng: 100.3685,
    cities: [
      'Alor Setar', 'Sungai Petani', 'Kulim', 'Langkawi', 'Baling',
      'Kota Setar', 'Kuala Muda', 'Pendang', 'Pokok Sena', 'Yan',
  ...
  },
  {
    ...
    cities: [
      ...
      'Nibong Tebal', 'Kepala Batas', 'Balik Pulau', 'Seberang Perai',
  ...
  },
  {
    ...
    lng: 102.2381,
    cities: [
      'Kota Bharu', 'Pasir Mas', 'Tanah Merah', 'Machang',
      'Kuala Krai', 'Gua Musang', 'Bachok', 'Tumpat',
      'Pasir Puteh', 'Jeli', 'Wakaf Bharu',
    ],
  },
  {
    id: 'terengganu',
    ...
    lng: 103.1324,
    cities: [
      'Kuala Terengganu', 'Dungun', 'Kemaman', 'Marang',
      'Hulu Terengganu', 'Besut', 'Setiu', 'Kuala Berang',
    ],
  },
  {
    id: 'perak',
    ...
    cities: [
      ...
      'Lumut', 'Manjung', 'Batu Gajah', 'Kuala Kangsar',
      'Kampar', 'Tapah', 'Bidor', 'Sungai Siput',
      'Gerik', 'Lenggong', 'Parit Buntar',
    ],
  },
  {
    id: 'pahang',
    ...
    cities: [
      ...
      'Mentakab', 'Raub', 'Jerantut', 'Pekan',
      'Rompin', 'Bera', 'Lipis', 'Gua Musang',
    ],
  },
  {
    id: 'selangor',
    ...
    cities: [
      ...
      'Ampang', 'Cheras', 'Puchong', 'Rawang',
      'Kajang', 'Semenyih', 'Sepang', 'Bangi',
      'Selayang', 'Batu Caves', 'Gombak', 'Hulu Langat',
      'Kuala Selangor', 'Sabak Bernam', 'Kapar', 'Kuala Langat',
    ],
  },
  {
    id: 'kuala-lumpur',
    ...
    lng: 101.6869,
    cities: [
      'Kuala Lumpur', 'Cheras', 'Kepong', 'Bangsar',
      'Wangsa Maju', 'Setapak', 'Bukit Bintang', 'Titiwangsa',
      'Seputeh', 'Brickfields', 'Damansara',
    ],
  },
  {
    id: 'putrajaya',
  ...
  },
  {
    ...
    cities: [
      ...
      'Kuala Pilah', 'Jempol', 'Tampin', 'Rembau',
    ],
  },
  {
    id: 'melaka',
    ...
    cities: [
      ...
      'Merlimau', 'Ayer Keroh', 'Batu Berendam',
    ],
  },
  {
    id: 'johor',
    ...
    lng: 103.7414,
    cities: [
      'Johor Bahru', 'Batu Pahat', 'Muar', 'Kluang', 'Pasir Gudang',
      'Skudai', 'Kulai', 'Kota Tinggi', 'Mersing',
      'Segamat', 'Pontian', 'Tangkak', 'Ayer Hitam',
      'Senai', 'Gelang Patah', 'Iskandar Puteri',
    ],
  },
  {
    id: 'sarawak',
    ...
    cities: [
      ...
      'Samarahan', 'Sri Aman', 'Kapit', 'Sarikei',
      'Mukah', 'Limbang', 'Lawas', 'Betong',
    ],
  },
  {
    id: 'sabah',
    ...
    cities: [
      ...
      'Keningau', 'Beaufort', 'Ranau', 'Kudat',
      'Semporna', 'Papar', 'Tuaran', 'Penampang',
    ],
  },
  {
    id: 'labuan',
